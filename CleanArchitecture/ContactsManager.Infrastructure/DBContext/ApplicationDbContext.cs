...
namespace ContactsManager.Infrastructure.DBContext
{
    public class ApplicationDbContext : IdentityDbContext<ApplicationUser,ApplicationRole,Guid>
    {
        ...
        public virtual DbSet<Person> PersonsData { get; set; }

        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            base.OnModelCreating(modelBuilder);

            // Map to correct tables
            modelBuilder.Entity<Country>().ToTable("Countries");
            modelBuilder.Entity<Person>().ToTable("PersonsData"); // FIXED
        ...
        {
            return PersonsData.FromSqlRaw("EXECUTE [dbo].[GetAllPersons]").ToList();
        }
